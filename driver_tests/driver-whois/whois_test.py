from qai_whois.connector import WhoisConnector as PlatformConnector 
from qai_whois.driver import WhoisDriver as PlatformDriver 
from whois_test_cases import TEST_CASES as test_cases 
