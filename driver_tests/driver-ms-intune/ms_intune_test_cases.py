...
TEST_CASES: dict[str, dict[str, Any]] = {
    ...
    "049": {
        "filter": S(name__iin=frozenset(["eric.jones@queryengineering.onmicrosoft.com", "mike@queryengineering.onmicrosoft.com"])),
        "time_range_filter": S(),
        "expected": True,
        "entity": User,
        "followups": {},
    ...
    "050": {
        "filter": S(hostname__istartswith="vm") & S(hostname__endswith="5"),
        "time_range_filter": S(),
        "expected": False,
        "entity": Device,
        "followups": {},
